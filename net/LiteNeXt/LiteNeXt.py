...
from Utils_module import SMmoduleplusplus, SMmodulesimple, Layernorm, DownStagePluss,\
      UpDownstream, AttentionDC, SimpleAttentionDC, RB

class LiteNeXt(nn.Module):
    def __init__(self, in_channel=16, n_classes=3, conf_layer_encoder = [1,1,1,1], kernel_sizes=[3,3,3,3], dilate = [1, 1, 1, 1]):
        ...
        self.head = nn.Conv2d(in_channel, n_classes, 1)
...
if __name__ == "__main__":
    ...
    model = LiteNeXt(n_classes=4).to(device)
